...
export default function AuthPage() {
  ...
  return (
    <main style={backgroundStyle}>
      ...
      <p style={footerNoteStyle}>© 2024 CONTRATA EMPREGOS - CONEXÕES REAIS</p>
    </main>
  );
}

// ESTILOS COM FOCO NO VISUAL "BONITO"
...
const lightEffect1: React.CSSProperties = {
  position: 'absolute', width: '400px', height: '400px', borderRadius: '50%',
  background: 'radial-gradient(circle, rgba(37,99,235,0.15) 0%, transparent 70%)',
  top: '-100px', left: '-100px', zIndex: 0
};

const lightEffect2: React.CSSProperties = {
  position: 'absolute', width: '400px', height: '400px', borderRadius: '50%',
